...
const ViewInterestRate = () => {
  const details = [
    { label: "Transaction ID", value: "B02337" },
    { label: "Start Date", value: "06/11/2023" },
    { label: "End Date", value: "06/11/2023" },
...
export default ViewInterestRate;
