...
import { OperationRoutes } from "../../lib/Admin/routes";
...
export default function OperationLayout({ children }: OnboardingLayoutProps) {
  return (
    <main className="w-full">
      <Sidebar title="Administrations" routes={OperationRoutes} />
